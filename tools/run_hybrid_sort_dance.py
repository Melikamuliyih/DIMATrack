...
def main(exp, args, num_gpu):
    ...
    if args.benchmark == "dancetrack":
        hota_command = "python3 tools/run_mot_challenge.py " \
                       "--SPLIT_TO_EVAL val  " \
                       "--METRICS HOTA CLEAR Identity " \
                       "--GT_FOLDER /root/userfolder/BoT-SORT/tools/datasets/dancetrack/val " \
                       "--SEQMAP_FILE /root/userfolder/BoT-SORT/tools/datasets/dancetrack/val/val_seqmap.txt " \
                       "--SKIP_SPLIT_FOL True " \
                       "--TRACKERS_TO_EVAL '' " \
                       "--TRACKER_SUB_FOLDER ''  " \
                       "--USE_PARALLEL True " \
