...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/userfolder/BoT-SORT/logs/MOT17/sbs_S50/jdecmc_best_mot17.pth.tar', help='model.pt path(s)')
    ...
    parser.add_argument("--fast-reid-config", dest="fast_reid_config", default=r"/root/userfolder/BoT-SORT/logs/MOT17/sbs_S50/jdecmc_best_mot17.pth.tar",
                        type=str, help="reid config file path")
    parser.add_argument("--fast-reid-weights", dest="fast_reid_weights", default=r"/root/userfolder/BoT-SORT/logs/MOT17/sbs_S50/jdecmc_best_mot17.pth.tar",
                        type=str, help="reid config file path")
        ...
        for i in seqs:
            ...
            if opt.default_parameters:
                ...
                if MOT == 20:  # MOT20
                    ...
                    if ablation:
                        opt.weights = r'/root/userfolder/BoT-SORT/logs/MOT17/sbs_S50/jdecmc_best_mot17.pth.tar'
                    else:
                        opt.weights = r'/root/userfolder/BoT-SORT/logs/MOT17/sbs_S50/jdecmc_best_mot17.pth.tar'
